...
SCNLIB_API void __stdcall ScnLib_SetVideoCodecExtraArgsA(LPCSTR pcszArgs);
SCNLIB_API void __stdcall ScnLib_GetVideoCodecExtraArgsA(LPSTR pszArgs); // pszArgs >= 1024 CHARs
SCNLIB_API void __stdcall ScnLib_SetVideoCodecExtraArgsW(LPCWSTR pcwszArgs);
SCNLIB_API void __stdcall ScnLib_GetVideoCodecExtraArgsW(LPWSTR pwszArgs); // pwszArgs >= 1024 WCHARs
...
SCNLIB_API BOOL __stdcall ScnLib_AddMP4BookmarkA(LPCSTR pcszBookmark); // pcszBookmark <= 1023 CHARs
SCNLIB_API BOOL __stdcall ScnLib_AddMP4BookmarkW(LPCWSTR pcwszBookmark); // pcwszBookmark <= 1023 WCHARs
