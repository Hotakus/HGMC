...
Namespace ZDSoft
	...
	Public Class SDK
		...
		Public Declare Unicode Sub ScnLib_SetVideoCodecExtraArgsW Lib "ScnLib.dll" (ByVal Args As String)
		Public Declare Unicode Sub ScnLib_GetVideoCodecExtraArgsW Lib "ScnLib.dll" (ByVal Args As String) ' Args >= 1024 Chars
		...
		Public Declare Unicode Function ScnLib_AddMP4BookmarkW Lib "ScnLib.dll" (ByVal Bookmark As String) As Boolean ' Bookmark <= 1023 Chars
