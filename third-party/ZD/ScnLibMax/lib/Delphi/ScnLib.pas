...
function  ScnLib_LoadSettingsA(RegKey: THandle; const SubKey: PChar): LongBool; stdcall; external 'ScnLib.dll';
function  ScnLib_LoadSettingsW(RegKey: THandle; const SubKey: PWideChar): LongBool; stdcall; external 'ScnLib.dll';
function  ScnLib_SaveSettingsA(RegKey: THandle; const SubKey: PChar): LongBool; stdcall; external 'ScnLib.dll';
function  ScnLib_SaveSettingsW(RegKey: THandle; const SubKey: PWideChar): LongBool; stdcall; external 'ScnLib.dll';
function  ScnLib_DeleteSettingsA(RegKey: THandle; const SubKey: PChar): LongBool; stdcall; external 'ScnLib.dll';
...
procedure ScnLib_SetStreamingUrlA(const URL: PChar); stdcall; external 'ScnLib.dll';
procedure ScnLib_GetStreamingUrlA(URL: PChar); stdcall; external 'ScnLib.dll'; // URL >= 2048 Chars
procedure ScnLib_SetStreamingUrlW(const URL: PWideChar); stdcall; external 'ScnLib.dll';
procedure ScnLib_GetStreamingUrlW(URL: PWideChar); stdcall; external 'ScnLib.dll'; // URL >= 2048 WideChars
...
function  ScnLib_SelectCaptureRegion(var left: Integer; var top: Integer; var right: Integer; var bottom: Integer): LongBool; stdcall; external 'ScnLib.dll';
...
procedure ScnLib_ConfigureVideoCodec(ParentWnd: THandle); stdcall; external 'ScnLib.dll';
procedure ScnLib_SetVideoCodecExtraArgsA(const Args: PChar); stdcall; external 'ScnLib.dll';
procedure ScnLib_GetVideoCodecExtraArgsA(Args: PChar); stdcall; external 'ScnLib.dll'; // Args >= 1024 Chars
procedure ScnLib_SetVideoCodecExtraArgsW(const Args: PWideChar); stdcall; external 'ScnLib.dll';
procedure ScnLib_GetVideoCodecExtraArgsW(Args: PWideChar); stdcall; external 'ScnLib.dll'; // Args >= 1024 WideChars
...
function  ScnLib_GetWebcamDeviceA(Index: Integer; Device: PChar): LongBool; stdcall; external 'ScnLib.dll'; // Device >= 260 Chars
function  ScnLib_GetWebcamDeviceW(Index: Integer; Device: PWideChar): LongBool; stdcall; external 'ScnLib.dll'; // Device >= 260 WideChars
...
function  ScnLib_AddMP4BookmarkA(const Bookmark: PChar): LongBool; stdcall; external 'ScnLib.dll'; // Bookmark <= 1023 Chars
function  ScnLib_AddMP4BookmarkW(const Bookmark: PWideChar): LongBool; stdcall; external 'ScnLib.dll'; // Bookmark <= 1023 WideChars
